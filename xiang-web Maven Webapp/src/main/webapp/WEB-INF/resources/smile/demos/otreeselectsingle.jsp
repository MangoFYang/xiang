...
<h:head title="otreeselectsingle" />
<h:body>
<d:demo/>
<%-- JS代码 --%>
<s:script src="/smile/demos/scripts/otreeselectsingle.js"></s:script>
<s:script><%-- 此处放置JS标签 --%>
	<s:otreeselectsingle renderTo="otreeselectsingle" data="nationalpeoplescongressofthecommunistpartyofchina" 
		value="44" label="中国共产党全国代表大会" title="中国共产党全国代表大会" parent4Root="999999" 
	...
	<s:otabs renderTo="tabs">
		...
		<s:otab caption="编程接口" renderTo="api" embedType="page" url="/smile/docs/smile.ui.otreeselectsingle.html"/>
...
<h:tab id="demo" height="95%">
	<h2>otreeselectsingle</h2>
	<h:div>
		<h:p>
			<h:div class="fixed">
				<h:input id="otreeselectsingle"/>
			</h:div>
			<h:pre>
	
	<strong>Script标签: </strong>

	&lt;s:otreeselectsingle renderTo="otreeselectsingle" data="td" value="44"
		label="otreeselectsingle" parent4Root="999999" displayField="name" valueField="id"
		parentIdField="pid" selectableField="selectable" /&gt;
