...
var PinYin = {
	mfkdb : [
		...
		[ 'Xie', '楔些歇蝎鞋协挟携邪斜胁谐写械卸蟹懈泄泻谢屑偕亵勰燮薤撷獬廨渫瀣邂绁缬榭榍蹀躞解' ],
		...
		[ 'Zhua', '抓爪' ], [ 'Zhuai', '拽' ], [ 'Zhuan', '专砖转撰赚篆啭馔颛' ],
		[ 'Zhui', '椎锥追赘坠缀萑惴骓缒隹' ], [ 'Zhun', '谆准肫窀' ],
		[ 'Zhuo', '捉拙卓桌琢茁酌啄灼浊倬诼擢浞涿濯禚斫镯' ],
		[ 'Zi', '兹咨资姿滋淄孜紫仔籽滓子自渍字谘呲嵫姊孳缁梓辎赀恣眦锱秭耔笫粢趑訾龇鲻髭' ],
		[ 'Zong', '鬃棕踪宗综总纵偬腙粽' ], [ 'Zou', '邹走奏揍诹陬鄹驺鲰' ],
		[ 'Zu', '租足族祖诅阻组俎菹镞' ], [ 'Zuan', '钻纂攥缵躜' ], [ 'Zui', '嘴醉最罪蕞觜' ],
		[ 'Zun', '尊遵撙樽鳟' ], [ 'Zuo', '昨左佐做作坐座阼唑怍胙祚笮' ], [ 'Ei', '诶' ],
		[ 'Dia', '嗲' ], [ 'Cen', '岑涔' ], [ 'Nou', '耨' ] 
	],
	go : function(hanzi, onlyCaption) {
		var str = hanzi.replace(/(^\s*)|(\s*$)/g, '');
		var e = '';
		var c, l1;
...
$.extend($.smile.util, {
	...
	/**
	 * 汉字转拼音
	 * @param {String} haizi 需要转换的汉字。
	 * @param {Boolean} onlyCaption 只需要首字母。
	 * @returns 拼音
	 */
