...
$.widget("smile.olistselectsingle", $.smile.osinglebox, {
	
	options: {
		
		// 覆盖选项
		title: "oListselectsingle Title",
	 ...
	 */
	_setValue: function() {
		this._nodeData = this._list.opageablelist("getData", this._list.opageablelist("getSelected"));
	...
	setData: function(data) {
		...
		this._list.opageablelist("setData", data);
	}
